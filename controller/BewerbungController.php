...
class BewerbungController
{
    ...
    {
        $view = new View('lebenslauf');
        $view->title = 'Lebenslauf';
        $view->heading = 'Lebenslauf';
        $view->display();
    }

    public function bewerbung()
    {
        $view = new View('Bewerbung');
        $view->title = 'Bewerbung';
        $view->heading = 'Bewerbung';
        $view->display();
    }
